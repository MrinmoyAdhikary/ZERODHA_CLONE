function Hero(){
    return ( 
        ...
        <div className="row mt-5 mb-5 p-2">
            <h1 className="text-center mt-5">We pioneered the discount broking model in India.<br/>
Now, we are breaking ground with our technology.</h1>
        </div>
        <hr/>
        <div className="row mt-5 mb-5">
            <div className="col mt-5 p-5 fs-5 text-muted">
...
<p>Over 1.6+ crore clients place billions of orders every year through our powerful ecosystem of investment platforms, contributing over 15% of all Indian retail trading volumes.</p>
            ...
            <div className="col  mt-5 p-5 fs-5 text-muted">
                <p>n addition, we run a number of popular open online educational and community initiatives to empower retail traders and investors.</p><br/>
